...
namespace Achievers.ControlCustom
{
    ...
    public partial class FlipCard : UserControl
    {
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register("Title", typeof(string), typeof(FlipCard), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty DefProperty =
            DependencyProperty.Register("Def", typeof(string), typeof(FlipCard), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty ImagesProperty =
            DependencyProperty.Register("Images", typeof(string), typeof(FlipCard), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty BookImageProperty =
            DependencyProperty.Register("BookImage", typeof(string), typeof(FlipCard), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty IdProperty =
            DependencyProperty.Register("Id", typeof(int), typeof(FlipCard), new PropertyMetadata(-1));
        ...
        public static readonly DependencyProperty IsActiveProperty =
            DependencyProperty.Register("IsActive", typeof(bool), typeof(FlipCard), new PropertyMetadata(false));
    }
}